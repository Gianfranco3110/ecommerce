            ...
            <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                    <a href="#" class="muted-link pb-1 d-inline-block breadcrumb-back">
                        ...
                        <span class="text-small align-middle">Shopping Cart</span>
                    </a>
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                        <div class="h-100 row g-0 card-body align-items-center py-3">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center lh-1-25">Carritos Abandonados</div>
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                        <div class="h-100 row g-0 card-body align-items-center py-3">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center lh-1-25">Order Carritos Procesados</div>
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                        <div class="h-100 row g-0 card-body align-items-center py-3">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center lh-1-25">Totales en Carrito</div>
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                        <div class="h-100 row g-0 card-body align-items-center py-3">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center lh-1-25">Profit Mensual</div>
