...
class SalesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('orders.list')->with('sales',$sales);
    }
    ...
    public function edit($id)
    {
        ...
        return view('orders.editStatus')->with('sale',$sale);
    ...
    public function update(Request $request, Sales $sales, $id)
    {
        ...
        if ($oldstatus != $newstatus) {
         ...
         Mail::to($sale->user->email)->send(new ChageStatusOrder($sale));
        ...
        return redirect('orders')->with('mensaje',$mensaje);
    }
