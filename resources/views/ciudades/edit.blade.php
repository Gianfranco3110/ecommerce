        ...
        <div class="col-12 mb-0">
            ...
            {!! Form::model($city, ['route' => ['city.update', $city->id], 'method' => 'patch']) !!}
                            ...
                            <div class="row p-4">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-xl-6 col-xxl-6 mb-5 mt-2">
                                    {!! Form::label('pais', "Selecione País",['class' => 'bold']) !!}
                                    {!! Form::select('pais', $country, null, ['class' => 'select2 form-control round', 'id'=>'country']) !!}
                                </div>
                                
                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-xl-6 col-xxl-5 mb-4 mt-2">
                                    {!! Form::label('id_state', "Estado",['class' => 'bold']) !!}
                                    <select class="select2 not-required form-control round" id="id_state" name="state">
                                        <option value="">{{$city->estadoName->name}}</option>
                                    </select>
                                </div> 
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-xl-6 col-xxl-5 mb-4">
                                    ...
                                    <select class="select2 required form-control round" id="ciudad" name="name" required>
