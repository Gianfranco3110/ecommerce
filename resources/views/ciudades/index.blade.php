    ...
    <div class="container">
        ...
        <div class="page-title-container">
            ...
            <div class="ir_derecha">
                <a href="{{route('city.create')}}" class="btn btn-1 btn_style" style="width: 10%;">Agregar</a>
            </div>
        </div>
                                ...
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-start custom-sort">
                                        ...
                                        <div class="col-lg-1 d-flex flex-column pe-1 justify-content-center">
                                         ...
                                         <div class="col-lg-1 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-medium cursor-pointer sort" data-sort="group">Pais</div>
                                        </div>
                                         <div class="col-lg-1 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-medium cursor-pointer sort" data-sort="group">Estado</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                            <div class="col-12 col-lg-2 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-2">
                                                <div class="lh-1 text-alternate"> {{$city->name}}</div>
                                            </div>
                                        <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                            <span class="lh-1 text-alternate">{{$city->status}}</span>
                                        </div>
                                         <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                            <span class="lh-1 text-alternate">{{$city->paisName->name}}</span>
                                        </div>
                                         <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                            <span class="lh-1 text-alternate">{{$city->estadoName->name}}</span>
                                        </div>
                                        <div class="col-1 d-flex flex-column mb-2 mb-lg-0 align-items-end order-2 order-lg-last justify-content-lg-center">
                                            ...
                                            <div class="btn-group ms-1 check-all-container">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{route('city.edit',['id'=>$city->id])}}">
