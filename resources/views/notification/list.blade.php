                            ...
                            <div class="col">
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-start custom-sort">
                                        ...
                                        <div class="col-lg-1 d-flex flex-column pe-1 justify-content-center me-2">
                                    ...
                                    <div class="row g-0 h-100 align-content-center">
                                        <div class="col-12 col-lg-2 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-2">
                                            <div class="lh-1 text-alternate">
                                                    ...
                                                    <img class="img-thumbnail img-fluid" src="../storage/{{$dato->icon}}" class="img-thumbnail" width="100" alt="">
                                        ...
                                        <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5 me-2">
                                        ...
                                        <div class="col-12 col-lg-1 d-flex flex-column pe-1 mb-2 mb-lg-0 align-items-start justify-content-center order-5">
                                            <span class="lh-1 text-alternate">{{$dato->link}}</span>
                                        </div>
