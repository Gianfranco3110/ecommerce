    ...
    <div class="row">
        ...
        <div class="col-xl-8">
                    ...
                    <div class="card-body">
                        <form  action="{{route('store.product')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 w-50">
                                ...
                                <input type="text" class="form-control" name="name" value="" placeholder="Nombre del producto" required/>
                            </div>
                            <div class="mb-3 w-50">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="sku" value="" palceholder="sku" required/>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">Cantidad</label>
                                <input type="number" class="form-control" name="stock" value="" palceholder="stock" required/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Cantidad Minima de Venta</label>
                                <input type="number" class="form-control" name="minimaVenta" value="" palceholder="minima venta" required/>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">Stock Nivel Bajo</label>
                                <input type="number" class="form-control" name="stockLowLevel" value="" palceholder="stock low level" required/>
                            </div>
                            ...
                            <div class="mb-n6 border-last-none">
                                <div class="mb-3 pb-3 border-bottom border-separator-light">
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-md order-3">
                                            <div class="mb-0">
                                                ...
                                                <input name="attributes"class="form-control m_campo" value="" placeholder="Tags" required />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-md order-3">
                                            <div class="mb-0">
                                                <input class="form-control m_campo" name="meta_title" value="" placeholder="Meta Titulo" required/>
                                            </div>
                                        </div>
                                        <div class="col-auto order-2 order-md-4">
                                            <label class="d-block form-label">&nbsp;</label>
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-md order-3">
                                            <div class="mb-0">
                                                <input class="form-control m_campo" name="meta_description" value="" placeholder="Meta Descripción" required />
                                            </div>
                                        </div>
                                        <div class="col-auto order-2 order-md-4">
                                            <label class="d-block form-label">&nbsp;</label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="0" type="text" name="price" class="form-control" required id="price"/>
                            </div>
                               ...
                               <div class="mb-3">
                                ...
                                <input type="checkbox" class="" name="productPromo" id="promo" value="1"/>
                                
                                
                            </div>
                               <div class="mb-3">
                                <label class="form-label">Producto Top. ?</label>
                                <input type="checkbox" class="" name="productTop" id="isTop" value="1"/>
                            ...
                            <div class="mb-3" style="display: none" id="divValorIva">
                                ...
                                <input type="text" name="valorIva" class="form-control" value="0" required id="valorIva" onkeyup="sumar()"/>
                            </div>
                            
                            <div class="mb-3" style="display: none" id="divPrecioIva">
                                <label class="form-label">Precio inlc.Iva $</label>
                                <input type="text" name="priceIva" class="form-control" value="0" readonly id="priceConIva"/>
                            </div>

                             <div class="mb-3" style="display: none" id="divValorPromocion">
                                <label class="form-label">Valor en promocion</label>
                                <input type="number" name="valorPromo" class="form-control" value="0" required id="valorPromo"/>
                            </div>
            ...
            <div class="col-xl-4 mb-2">
                ...
                <div class="card"> 
                    <div class="card-body">
                        <div class="dropzone dropzone-columns row g-2 row-cols-2 row-cols-md-4 row-cols-xl-2 border-0 p-0" id="dropzoneProductGallery2">
