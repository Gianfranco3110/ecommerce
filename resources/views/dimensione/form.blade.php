<div class="box box-info padding-1" style="font-size: 20px">
    <div class="box-body">
            ...
            {{ Form::label('name','Dimension',['class'=>'mb-4']) }}
            {{ Form::text('name',$dimensione->name,['class' => 'form-control' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'nombre']) }}
   ...
   <div class="form-group col-xs-12 col-sm-12 col-md-6 col-xl-6 col-xxl-4 mt-4">
            ...
            <label class="checkbox-inline">
                ...
                {!! Form::checkbox('status', '1',$dimensione->status, null) !!}
            </label>
        </div>
