                ...
                <div id="checkboxTable">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 h-100 sh-lg-9 position-relative">
                            ...
                            {{-- {{dd($venta->cart->details)}} --}}
                            <a href="{{route('producto.show', [$item->product->id])}}" class="col-auto position-relative">
                            ...
                            <div class="col py-4 py-lg-0">
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-center">
                                        <a href="{{route('producto.show', [$item->product->id])}}"
                                        ...
                                        <div class="col-12 col-lg-2 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-3">
                                            <div class="lh-1 text-alternate">{{$item->product->stock}}</div>
                                        </div>
                                        <div class="col-12 col-lg-3 d-flex flex-column pe-1 mb-2 mb-lg-0 justify-content-center order-4">
                                            <div class="lh-1 text-alternate">$ {{$item->product->price}}</div>
                                        </div>
