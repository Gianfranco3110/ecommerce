    ...
    <div class="row ">
        <div class="col-auto mb-3 mb-md-0 me-auto">
            <div class="w-auto sw-md-30">
                ...
                <h1 class="mb-0 pb-0 display-4" id="title">Tienda</h1>
            </div>
        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card sh-30 sh-sm-30 hover-img-scale-up">
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                            <div>
                                <h3 class=" m-auto text-black display-1  text-center mt-5">Tienda</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-2">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="{{route('producto.show', [$producto->id])}}" class="body-link lh-1-5 clamp-line" data-line="2">{{$producto->name}}</a>
                                </h5>
                            </div>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-2">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Good Glass Teapot</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Modern Dark Pot</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Wood Handle Hunter Knife</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Wireless On-Ear Headphones</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">White Coffee Mug</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Geometric Chandelier</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">XBox Controller</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/producto" class="body-link lh-1-5 clamp-line" data-line="2">Health and Fitness Smartwatch</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/product" class="body-link lh-1-5 clamp-line" data-line="2">Good Glass Teapot</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-3">
                                <h5 class="heading mb-0 d-flex">
                                    ...
                                    <a href="/product" class="body-link lh-1-5 clamp-line" data-line="2">Modern Dark Pot</a>
                                </h5>
                            </div>
                            <div class="card-footer border-0 pt-0">
                                <div class="mb-2">
